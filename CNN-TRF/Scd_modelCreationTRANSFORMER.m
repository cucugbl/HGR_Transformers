...
%% SAVE MODEL
save(['ModelsLSTM/TransformerModel_8-128_', datestr(now,'dd-mm-yyyy_HH-MM-ss')], 'net');
...
tempLayers = sequenceInputLayer([13 24 8],"Name","sequence");
...
tempLayers = [
    ...
    selfAttentionLayer(8,128,"Name","selfattention","NumValueChannels",128,"OutputSize",22464)
