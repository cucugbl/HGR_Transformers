...
modelFileName = 'ModelsLSTM\TCNNposenco_8_128__28-09-2023_01-50-57.mat'; 
...
function [labels, timestamps, processingTimes] = evaluateSampleFrames(signal, groundTruth, net)
    ...
    for i = 1:numWindows
        ...
        % Classify the frame
        [net, predicction, predictedScores] = classifyAndUpdateState(net,sequence);
    ...
    for k = 1:numel(timestamps)
        processingTimes(1, i) = processingTime/numel(timestamps);
