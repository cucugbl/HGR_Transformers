...
%% SAVE MODEL
save(['ModelsLSTM/OnlyTransformer_8_128__', datestr(now,'dd-mm-yyyy_HH-MM-ss')], 'net');
...
if Shared.includeTesting
    ...
    fprintf('\n%s\n%s\n', strAccValidation, strAccValidation);
end
...
% %% SAVE MODEL
% save(['ModelsLSTM/OnlyTransformer_8_512', datestr(now,'dd-mm-yyyy_HH-MM-ss')], 'net');
...
tempLayers = [
    ...
    selfAttentionLayer(8,128,"Name","selfattention")
