...
tempLayers = selfAttentionLayer(16,256,"Name","selfattention","NumValueChannels",512,"OutputSize",2496);
lgraph = addLayers(lgraph,tempLayers);
...
lgraph = connectLayers(lgraph,"addition","selfattention");
lgraph = connectLayers(lgraph,"addition","addition_1/in2");
lgraph = connectLayers(lgraph,"selfattention","addition_1/in1");
end
